...
import com.ace.jvm.loader.ClassFileLoader;

public class ClassFileloaderTest {

	private static final String FULL_QUALIFIED_CLASS_NAME = "com/ace/jvm/test/EmployeeV1";
	
	static String path1 = "D:\\Upgrade\\coding2017\\group03\\664269713\\DataStructure\\bin";
	...
	static {
		...
		String className = "com.ace.jvm.test.EmployeeV1";
...
//		clzFile.print();
	...
	public void testClassFileLength() {		
		...
		Assert.assertEquals(809, byteCodes.length);
