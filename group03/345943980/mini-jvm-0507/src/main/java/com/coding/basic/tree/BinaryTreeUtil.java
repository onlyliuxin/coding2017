...
public class BinaryTreeUtil {
	...
	private static <T> List<T> preOrderVisit(BinaryTreeNode<T> node, List<T> result) {
		if (node == null) {
			return null;
		}
	...
	private static <T> List<T> inOrderVisit(BinaryTreeNode<T> node, List<T> result) {
		if (node == null) {
			return null;
		}
	...
	private static <T> List<T> postOrderVisit(BinaryTreeNode<T> node, List<T> result) {
		if (node == null) {
			return null;
		}
