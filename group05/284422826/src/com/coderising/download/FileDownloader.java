...
public class FileDownloader {
    ...
    public void execute() {
        ...
        try {
            ...
            int block = length % THREADNUM == 0 ? length / THREADNUM
                    : length / THREADNUM + 1;
            ...
            for (int i = 0; i < THREADNUM; i++) {
                ...
                downloadThreads[i] = new DownloadThread(conn, startPos, endPos, url);
    ...
    public boolean downloadFinish(){
        ...
        for (int i = 0; i < THREADNUM; i++) {
            finished = finished && downloadThreads[i].finished;
        }
