...
public class InfixExprTest {
	...
	public void testEvaluate() {
		...
		{
			InfixExpr expr = new InfixExpr("5-2+3");
			Assert.assertEquals(6.0, expr.evaluate(), 0.001f);
		}
		{
		...
		{
			InfixExpr expr = new InfixExpr(" 5-2-2+3");//5+3-2-2
			Assert.assertEquals(4, expr.evaluate(), 0.001f);
		}
		{
			InfixExpr expr = new InfixExpr("75/3/5*5"); //75*5/3/5  0.6
			Assert.assertEquals(25.0, expr.evaluate(), 0.001f);
		}
