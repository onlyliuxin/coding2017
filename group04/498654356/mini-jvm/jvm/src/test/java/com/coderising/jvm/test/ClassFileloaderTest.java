...
public class ClassFileloaderTest {
	...
	private static final String TEST_EMPLOYEE_V1_CLASS = "com.coderising.jvm.test.EmployeeV1";
	...
	static {
		...
		String className = TEST_EMPLOYEE_V1_CLASS;
...
//		clzFile.print(); //TODO
    ...
    private void assertMethodEquals(ConstantPool pool,Method m , String expectedName, String expectedDesc,String expectedCode){
		...
		String methodDesc = pool.getUTF8String(m.getDescIndex());    		
