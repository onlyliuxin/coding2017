...
import cn.xl.jvm.loader.ClassFileLoader;
import cn.xl.jvm.loader.ClassFileParser;
...
public class ClassFileloaderTest {
	...
	private static final String FULL_QUALIFIED_CLASS_NAME = "cn/xl/jvm/loader/EmployeeV1";


	static String path1 = "D:/trainingworkspace/lesson01/target/classes";
	static String path2 = "D://??";

	static ClassFile clzFile = null;
	static {
		ClassFileLoader loader = new ClassFileLoader();
		loader.addClassPath(path1);
		String className = "cn.xl.jvm.loader.EmployeeV1";
