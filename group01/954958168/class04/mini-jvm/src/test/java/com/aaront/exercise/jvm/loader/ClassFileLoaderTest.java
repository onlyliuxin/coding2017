...
public class ClassFileLoaderTest {
    private static String path1 = "/Users/tonyhui/Code/coding2017/group01/954958168/class04/mini-jvm/target/classes";
    ...
    public void testClassFileLength() throws IOException {
        ClassFileLoader loader = new ClassFileLoader();
        loader.addClassPath(path1);
        String className = "com.aaront.exercise.jvm.loader.EmployeeV1";
