...
import week08.jvm.cmd.BiPushCmd;
import week08.jvm.cmd.ByteCodeCommand;
import week08.jvm.cmd.GetFieldCmd;
import week08.jvm.cmd.GetStaticFieldCmd;
import week08.jvm.cmd.InvokeSpecialCmd;
import week08.jvm.cmd.InvokeVirtualCmd;
import week08.jvm.cmd.LdcCmd;
import week08.jvm.cmd.NewObjectCmd;
import week08.jvm.cmd.NoOperandCmd;
import week08.jvm.cmd.PutFieldCmd;
...
public class CommandParser {
	...
	public static ByteCodeCommand[] parse(ClassFile clzFile, String codes) {
		if (codes == null || codes.length() == 0) {
			throw new RuntimeException("error codes");
		}
		...
		while (iter.hasNext()) {
			...
			if (new_object.equals(opCode)) {
				...
				throw new RuntimeException("the code instruction " + opCode + " has not been implemented.");
			}
		}
