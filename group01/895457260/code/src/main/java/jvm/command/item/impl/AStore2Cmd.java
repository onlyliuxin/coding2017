 ...
 * TODO:
 */
public class AStore2Cmd extends NoOperandCmd {
    public AStore2Cmd(ClassFile clzFile, String opCode, CommandIterator iterator) {
    ...
    public void execute(StackFrame frame, ExecutionResult result) {
        ...
        frame.setLocalVariableValue(2, object);
    }
}
