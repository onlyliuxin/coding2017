 ...
 * TODO:
 */
public class AStore0Cmd extends NoOperandCmd {
    public AStore0Cmd(ClassFile clzFile, String opCode, CommandIterator iterator) {
    ...
    public void execute(StackFrame frame, ExecutionResult result) {
        ...
        frame.setLocalVariableValue(0, object);
    }
}
