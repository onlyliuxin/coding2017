...
public class ClassFileloaderTest {
	...
	public void testConstantPool() {
...

		{
			...
			Assert.assertEquals(9, nameAndType.getIndex_Name());
			Assert.assertEquals(14, nameAndType.getIndex_Describe());
		}
		// 抽查几个吧
		{
	...
	public void testClassIndex() {
		...
		ClassInfo thisClassInfo = (ClassInfo) clzFile.getPool().getConstantInfo(clzIndex.getThisClassIndex());
		ClassInfo superClassInfo = (ClassInfo) clzFile.getPool().getConstantInfo(clzIndex.getSuperClassIndex());
