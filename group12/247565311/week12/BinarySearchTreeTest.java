...
public class BinarySearchTreeTest {
	...
	public void testRemoveLeaf() {
		...
		Assert.assertEquals(4, ((Integer)root.left.right.data).intValue());
	...
	public void testRemoveMiddleNode1() {
		tree.remove(4);
		BinaryTreeNode<Integer> root= tree.getRoot();
		Assert.assertEquals(5, ((Integer)root.left.right.data).intValue());
		Assert.assertEquals(3, ((Integer)root.left.right.left.data).intValue());
	}
	@Test
	public void testRemoveMiddleNode2() {
		tree.remove(2);
		BinaryTreeNode<Integer> root= tree.getRoot();
		Assert.assertEquals(3, ((Integer)root.left.data).intValue());
		Assert.assertEquals(4, ((Integer)root.left.right.data).intValue());
	}
