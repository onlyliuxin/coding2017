...
public class ExecutionResult {
	...
	public String toString(){
		...
		sb.append("ExecutionResult nextAction: " + getTypeStr(nextAction));
		sb.append(" next command: " + getNextCmdOffset());
		return sb.toString();
	}
	
	private String getTypeStr(int i){
		if(i == 1) return "RUN_NEXT_CMD";
		if(i == 2) return "JUMP";
		if(i == 3) return "EXIT_CURRENT_FRAME";
		if(i == 4) return "PAUSE_AND_RUN_NEW_FRAME";
		return "UNKNOWN EXECUTION RESULT TYPE";
	}
