...
public class ClassFile {
	...
	public String getClassName() {
		...
		ClassInfo thisClass = (ClassInfo) this.getConstantPool()
				.getConstantInfo(thisClassIndex);
		return thisClass.getClassName();
	}

	public String getSuperClassName() {
		ClassInfo superClass = (ClassInfo) this.getConstantPool()
				.getConstantInfo(this.clzIndex.getSuperClassIndex());
	...
	public Method getMethod(String methodName, String paramAndReturnType) {
		...
		while(iter.hasNext()){
			...
			String descriptor=pool.getUTF8String(tmp.getDescriptorIndex());
			if(name.equals(methodName)&&descriptor.equals(paramAndReturnType))return tmp;
