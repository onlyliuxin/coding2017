...
public class DownloadThread extends Thread{
    ...
    private download.FileDownloader fileDownloader;
    
	public DownloadThread(Connection conn, int startPos, int endPos, String tName, download.FileDownloader fileDownloader){
