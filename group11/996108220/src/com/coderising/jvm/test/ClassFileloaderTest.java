...
public class ClassFileloaderTest {
	...
	static String path1 = "F:\\mycoding2017\\group11\\996108220\\bin";
    ...
    public void testByteCodeCommand(){
    	{
	    	Method initMethod = clzFile.getMethod("<init>", "(Ljava/lang/String;I)V");
    	...
    	{
	    	Method setNameMethod = clzFile.getMethod("setName", "(Ljava/lang/String;)V");
    	...
    	{
	    	Method sayHelloMethod = clzFile.getMethod("sayHello", "()V");
